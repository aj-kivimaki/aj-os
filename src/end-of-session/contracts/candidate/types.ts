...
export type CandidateKnowledge = DeepReadonly<
  z.infer<typeof candidateKnowledgeSchema>
>;

/** Complete provenance for a candidate — traceable back to its session and sources. */
export type CandidateProvenance = DeepReadonly<
  z.infer<typeof candidateProvenanceSchema>
>;
